extends WeaponBase
## 깨진 거울 파편: 랜덤 방향으로 파편을 발사, 화면 경계에서 반사된다.


const SHARD_SPEED: float = 110.0
const SHARD_SIZE: Vector2 = Vector2(5, 5)
const SHARD_LIFETIME: float = 3.0
